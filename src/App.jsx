...
const LEGAL_DOCS = {
  privacy: {
    ...
    content: [
      { heading: "Who we are", body: "This website is operated by Naveen Sharma trading as FreelanceHub IT Services — a registered Osek Murshe (עוסק מורשה) under the Israel Tax Authority, Be'er Sheva. Contact: naveen.freelancehub@gmail.com" },
  ...
  legal: {
    ...
    content: [
      ...
      { heading: "Israeli business registration", body: "Registered Osek Murshe (עוסק מורשה) — Authorised Dealer\nIssued by: Israel Tax Authority (רשות המסים בישראל)\nRegistration date: 01 April 2025\n\nAs a registered Osek Murshe, FreelanceHub is authorised to issue tax invoices (חשבונית מס) and operate commercially under Israeli VAT law. Registration number is available on request for invoicing and contract purposes." },
  ...
  terms: {
    ...
    content: [
      { heading: "Scope", body: "These terms apply to all engagements with FreelanceHub IT Services (Naveen Sharma, registered Osek Murshe, Israel). They serve as a general reference; specific deliverables, timelines, and rates are defined in a written Statement of Work or contract signed before work begins." },
          ...
          <div className="flex items-center justify-between bg-blue-600 px-4 py-3">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full overflow-hidden ring-2 ring-white/30">
                <img src="/ella-avatar.jpeg" alt="Ella" className="h-full w-full object-cover object-center" />
              </div>
              <div>
