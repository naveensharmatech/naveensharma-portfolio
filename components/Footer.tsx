...
import { Zap, Mail, Linkedin, Github, Youtube, Facebook } from "@/components/SocialIcons";
...
const social = [
  ...
  { icon: Mail,     href: "mailto:naveen.freelancehub@gmail.com",             label: "Email" },
];
    ...
    <footer className="border-t border-white/10 bg-[#0a0f1e] mt-20">
      <div className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
          <p>© {new Date().getFullYear()} FreelanceHub IT Services. Registered Osek Murshe, Israel.</p>
